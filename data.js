...
// ================== Рецепты ==================
export const basicRecepie = {
  name: "Как готовить коктейли с АРАКС?",
  description: `✨ Одна бутылка АРАКС = 3 коктейля!
  <b>Базовый рецепт:</b>
  1. 40 мл любого алкоголя (джин, ром, текила, водка, бурбон — что вам ближе)
  2. 150 мл АРАКС любого вкуса
  3. Лёд — щедро, чтобы напиток был свежим
  4. Украшение — по вашему вкусу: долька цитруса, веточка мяты, ягода, специи
  5. Просто смешайте всё в большом бокале, украсьте и наслаждайтесь!`,
